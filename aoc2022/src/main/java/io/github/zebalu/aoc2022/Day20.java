...
public class Day20 {
    public static void main(String[] args) {
        List<Data> data = INPUT.lines().map(s -> new Data(Integer.parseInt(s))).toList();
        System.out.println(part1(data));
        System.out.println(part2(data));
    }

    private static long part1(List<Data> data) {
        return getResult(mix(data, 1));
    }

    private static long part2(List<Data> data) {
        var decrypted = data.stream().map(d -> new Data(d.value() * 811589153)).toList();
        var moved = mix(decrypted, 10);
        return getResult(moved);
    }
